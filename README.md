...
| 11notes/sabnzbd | 147MB | 1000:1000 | ❌ | amd64, arm64, armv7 |
...
* [5.1.0](https://hub.docker.com/r/11notes/sabnzbd/tags?name=5.1.0)
* [5.1.0-unraid](https://hub.docker.com/r/11notes/sabnzbd/tags?name=5.1.0-unraid)
* [5.1.0-nobody](https://hub.docker.com/r/11notes/sabnzbd/tags?name=5.1.0-nobody)
...
# REGISTRIES ☁️
```
docker pull 11notes/sabnzbd:5.1.0
docker pull ghcr.io/11notes/sabnzbd:5.1.0
docker pull quay.io/11notes/sabnzbd:5.1.0
```
...
*created 12.08.2026, 23:30:22 (CET)*