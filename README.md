...
# SABNZBD
![size](https://img.shields.io/badge/image_size-118MB-green?color=%2338ad2d)![5px](https://raw.githubusercontent.com/11notes/static/refs/heads/master/img/markdown/transparent5x2px.png)![pulls](https://img.shields.io/docker/pulls/11notes/sabnzbd?color=2b75d6)![5px](https://raw.githubusercontent.com/11notes/static/refs/heads/master/img/markdown/transparent5x2px.png)[<img src="https://img.shields.io/github/issues/11notes/docker-sabnzbd?color=7842f5">](https://github.com/11notes/docker-sabnzbd/issues)![5px](https://raw.githubusercontent.com/11notes/static/refs/heads/master/img/markdown/transparent5x2px.png)![swiss_made](https://img.shields.io/badge/Swiss_Made-FFFFFF?labelColor=FF0000&logo=data:image/svg%2bxml;base64,)
...
| ---: | ---: | :---: | :---: | :---: |
| 11notes/sabnzbd | 118MB | 1000:1000 | ❌ | amd64, arm64 |
| home-operations/sabnzbd | 125MB | 65534:65533 | ❌ | amd64, arm64 |
| linuxserver/sabnzbd | 181MB | 0:0 | ❌ | amd64, arm64 |
| hotio/sabnzbd | 259MB | 0:0 | ❌ | amd64, arm64 |
...
* [5.1.1](https://hub.docker.com/r/11notes/sabnzbd/tags?name=5.1.1)
* [5.1.1-unraid](https://hub.docker.com/r/11notes/sabnzbd/tags?name=5.1.1-unraid)
* [5.1.1-nobody](https://hub.docker.com/r/11notes/sabnzbd/tags?name=5.1.1-nobody)

### There is no latest tag, what am I supposed to do about updates?
It is my opinion that the ```:latest``` tag is a bad habbit and should not be used at all. Many developers introduce **breaking changes** in new releases. This would messed up everything for people who use ```:latest```. If you don’t want to change the tag to the latest [semver](https://semver.org/), simply use the short versions of [semver](https://semver.org/). Instead of using ```:5.1.1``` you can use ```:5``` or ```:5.1```. Since on each new version these tags are updated to the latest version of the software, using them is identical to using ```:latest``` but at least fixed to a major or minor version. Which in theory should not introduce breaking changes.

If you still insist on having the bleeding edge release of this app, simply use the ```:rolling``` tag, but be warned! You will get the latest version of the app instantly, regardless of breaking changes or security issues or what so ever. You do this at your own risk!

# REGISTRIES ☁️
```
docker pull 11notes/sabnzbd:5.1.1
docker pull ghcr.io/11notes/sabnzbd:5.1.1
docker pull quay.io/11notes/sabnzbd:5.1.1
```
...
*created 19.08.2026, 09:02:14 (CET)*