...
| ---: | ---: | :---: | :---: | :---: |
| home-operations/sabnzbd | 120MB | 65534:65533 | ❌ | amd64, arm64 |
| 11notes/sabnzbd | 144MB | 1000:1000 | ❌ | amd64, arm64, armv7 |
| linuxserver/sabnzbd | 171MB | 0:0 | ❌ | amd64, arm64, riscv64 |
| hotio/sabnzbd | 245MB | 0:0 | ❌ | amd64, arm64 |
...
* [5.0.1](https://hub.docker.com/r/11notes/sabnzbd/tags?name=5.0.1)
* [5.0.1-unraid](https://hub.docker.com/r/11notes/sabnzbd/tags?name=5.0.1-unraid)
* [5.0.1-nobody](https://hub.docker.com/r/11notes/sabnzbd/tags?name=5.0.1-nobody)
...
# REGISTRIES ☁️
```
docker pull 11notes/sabnzbd:5.0.1
docker pull ghcr.io/11notes/sabnzbd:5.0.1
docker pull quay.io/11notes/sabnzbd:5.0.1
```
...
*created 08.05.2026, 10:03:27 (CET)*