...
| ---: | ---: | :---: | :---: | :---: |
| home-operations/sabnzbd | 121MB | 65534:65533 | ❌ | amd64, arm64 |
| 11notes/sabnzbd | 145MB | 1000:1000 | ❌ | amd64, arm64, armv7 |
| linuxserver/sabnzbd | 172MB | 0:0 | ❌ | amd64, arm64, riscv64 |
| hotio/sabnzbd | 246MB | 0:0 | ❌ | amd64, arm64 |
...
* [5.0.2](https://hub.docker.com/r/11notes/sabnzbd/tags?name=5.0.2)
* [5.0.2-unraid](https://hub.docker.com/r/11notes/sabnzbd/tags?name=5.0.2-unraid)
* [5.0.2-nobody](https://hub.docker.com/r/11notes/sabnzbd/tags?name=5.0.2-nobody)
...
# REGISTRIES ☁️
```
docker pull 11notes/sabnzbd:5.0.2
docker pull ghcr.io/11notes/sabnzbd:5.0.2
docker pull quay.io/11notes/sabnzbd:5.0.2
```
...
*created 15.05.2026, 06:04:31 (CET)*